...
<div class="container">
  <h4>Primary Problems of India</h4>
    ...
    <div class="container">
        ...
        <form name="form1">
          <div class="form-group" id="namediv">
            ...
            <input type="text" class="form-control" id="name" oninput="validateName()" placeholder="Enter name" name="name" >
          </div>
          <div class="form-group" id="agediv">
            <label for="age">Age:</label>
            <input type="number" class="form-control" id="age" oninput="validateAge()"  placeholder="Enter Age" name="age" >
          </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="issue" name="problem">
                ...
                <option>Basic Sanitation</option>
                <option>Healthcare System</option>
            </select>
          </div>
          <input class="btn btn-success" type="button" onclick="getData()" value="Submit">
        </form>
      </div>
